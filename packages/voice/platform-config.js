 ...
 * This file defines settings for Android and macOS to integrate Vosk.
 * 
...
export const platform = {
  android: {
    platform: 'android',
    modelPath: '/data/data/com.kitt.android/models/vosk', // Path optimized for Android hardware
    performanceTarget: {
  ...
  macos: {
    platform: 'macos',
    modelPath: '/Applications/KITT.app/Contents/Resources/models/vosk', // Path for macOS app bundle
    performanceTarget: {
      latencyMs: 200, // Enforce 200ms latency rule
